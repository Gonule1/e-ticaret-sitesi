...
<head>
        ...
        <title>YOK ARTIK </title>
        <meta name="description" content="">
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <!-- Favicon -->
        <link rel="stylesheet" type="text/css" href="dropzone.scss">
        <script type="text/javascript" class="dropzone.js"></script>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                            ...
                                            <li class="megamenu-holder"><a href="shop-left-sidebar.html">Kategorİler </a>
                                              ...
                                              <li>
                                                <ul>
                                                     ...
                                                     <?php 
                              $kategori=$baglan->prepare("SELECT * FROM kategori  where kategori_durum=:kategori_durum and  kategori_sira between 1 and 10 limit 8");
                              ...
                              while($kategoricek=$kategori -> fetch(PDO :: FETCH_ASSOC)) { ?>
                                                    ...
                                                    <li>    
                                                    <ul>                   <?php 
                              $kategori=$baglan->prepare("SELECT * FROM kategori where kategori_durum=:kategori_durum and kategori_sira between 10 and 20 limit 8");
                              $kategori->execute(array(
                              ...
                              while($kategoricek=$kategori -> fetch(PDO :: FETCH_ASSOC)) { ?>
                                                    ...
                                                    <li>
                                                        <ul>
                                                                                   <?php 
                              $kategori=$baglan->prepare("SELECT * FROM kategori where kategori_durum=:kategori_durum and kategori_sira between 20 and 30 limit 8");
                              $kategori->execute(array(
