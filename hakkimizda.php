                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 order-last order-lg-first">
                            <div class="about-text-wrap">
                                <h2><span>Provide Best</span><?php echo $hakkimizdacek['hakkimizda_baslik'] ?> </h2>
                        ...
                        <div class="col-lg-5 col-md-10">
                            <div class="about-image-wrap">
                                <img class="img-full" src="adminpanel/resimler/hakkimizda/<?php echo $hakkimizdacek['hakkimizda_resim'] ?>" alt="About Us" />
                            </div>
                        </div>
                        <!-- About Image End -->
                    </div>
